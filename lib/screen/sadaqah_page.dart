...
const Size donationSuccessVideoFallbackSize = Size(720, 1520);
            ...
            children: [
              ...
              if (showTapHint)
                Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: IgnorePointer(child: TapGestureHint(progress: pulse)),
                ),
            ],
          ),
        ),
              ...
              if (widget.showHint)
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    const double slideHintSize = 76.0;
                    const double slideHintHeight = slideHintSize * 1.2;
                    const double slideDistance = 88.0;
