...
class _SadaqahPageState extends ConsumerState<SadaqahPage>
  ...
  void _resetAmountControls() {
    ...
    setState(() {
      _stepIndex = _minIndex; // back to 0.500
  ...
  // Helpers
  double get _currentOmr =>
      _omrSteps[_stepIndex.clamp(_minIndex, _maxIndex)];
  int get _currentBaisa => (_currentOmr * 1000).round();

  // Shown label: integers 1..39 (index 0 => 1, index 38 => 39)
  String get _amountLabel => _currentOmr.toInt().toString();
 ...
 Future<void> _payAndDonate(num amt) async {
  ...
  Widget build(BuildContext context) {
    ...
    //final tealDeep = const Color(0xFF0C3B34);
    //  final screen = MediaQuery.of(context).size;
    // final circleScale = screen.height < 750 ? 0.8 : 1.0;
          ...
          children: [
                ...
                child: Column(
                  children: [
                    ...
                    _QuickCircle(
                      ...
                      onTap: () => _payAndDonate(5.000), // 100 baisa
                    ),
                    ...
                    _DialWithSparkles(
                      ...
                      showTapHint: _dialTapHintVisible, // 👈 now used
                      onTap: _onDialTap,
                    ...
                    _QuickCircle(
                      ...
                      sub: 'Baisa / بيسة',
                      activeTextColor: Colors.black.withOpacity(.85),
                      onTap: () => _payAndDonate(0.100), // 1 OMR
                    ),
            ...
            Align(
              ...
              child: Padding(
                ...
                child: SizedBox(
                  height: 450, // was ~340 → taller
                  width:
                      90, // roughly from top quick circle to bottom quick circle
                  child: _AmountSlider(
                    minIndex: _minIndex,
                    maxIndex: _maxIndex,
                    ...
                    onSlideStart: _onSliderStart, // 👈 use wrapper
                    onSlideEnd: _onSliderEnd,
                    showHint:
                        _sliderHintVisible, // 👈 controls finger animation
                  ),
                ),
              ),
            ),
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          // Finger icon
          const Icon(Icons.touch_app_rounded, color: Colors.white, size: 30),
        ],
      ),
    );
  }
        ...
        child: Stack(
          children: [
            ...
            const Positioned(
              ...
              child: Icon(
                Icons.touch_app_rounded,
                size: 36, // Slightly smaller to reveal black border
                color: Colors.white,
              ),
            ),
          ],
