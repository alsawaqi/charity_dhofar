...
import 'package:charity_dhofar/providers/mosambee_provider.dart';
import 'package:charity_dhofar/screen/sadaqah_page.dart';
...
void main() {
  ...
  testWidgets('PaymentLoadingDialog shows bilingual payment loading state', (
    ...
    expect(find.text('جاري التحويل إلى الدفع'), findsOneWidget);
  ...
  testWidgets('DonationResultDialog shows graceful success copy', (
    ...
    expect(find.text('تم استلام صدقتك'), findsOneWidget);
    expect(
  ...
  testWidgets('DonationResultDialog shows gentle failure copy', (
    ...
    expect(find.text('لم تكتمل عملية الدفع'), findsOneWidget);
    expect(
